                        ...
                        <div className="space-y-4">
...

                            {
                                role === "ADMIN" || data?.subscription?.status === "ACTIVE" ? (
                                    ...
                                    <button className="bg-yellow-600 text-xl rounded-md font-bold px-5 py-3 w-full hover:bg-yellow-500 transition-all ease-in-out duration-300" onClick={()=>navigate("/checkout")}>
                                        Subscribe
                                    </button>
                                )
                            }
